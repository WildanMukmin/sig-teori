...
<body class="bg-gray-50">
        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <ul class="hidden md:flex space-x-8">
                    ...
                    <li><a href="/pages/kepadatan.php" class="text-gray-600 hover:text-blue-600 transition">Kepadatan Penduduk</a></li>
                    ...
                    <li><a href="/pages/ibadah.php" class="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">Sarana Ibadah</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <section class="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl text-purple-100">Pemetaan dan Analisis <?= number_format($total_sarana) ?> Tempat Ibadah</p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                foreach ($kategori_items as $kategori => $jumlah):
                    $color = $colors[$index];
                ?>
                <div class="bg-gradient-to-br <?= $color[0] ?> <?= $color[1] ?> rounded-lg p-6 text-center hover:shadow-lg transition">
        ...
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-kecamatan" class="w-4 h-4"><span class="text-gray-700">Batas Kecamatan</span></label>
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-pendidikan" class="w-4 h-4"><span class="text-gray-700">Fasilitas Pendidikan (362)</span></label>
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-kesehatan" class="w-4 h-4"><span class="text-gray-700">Rumah Sakit (24)</span></label>
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-ibadah" checked class="w-4 h-4"><span class="text-gray-700">Sarana Ibadah (<?= $total_sarana ?>)</span></label>
                </div>
            </div>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <h3 class="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">Analisis Distribusi Sarana Ibadah</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-purple-600">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-purple-600 mr-2">•</span>Tanjung Karang Pusat</li>
                        <li class="flex items-start"><span class="text-purple-600 mr-2">•</span>Tanjung Karang Timur</li>
                        <li class="flex items-start"><span class="text-purple-600 mr-2">•</span>Teluk Betung Selatan</li>
                    ...
                    <div class="bg-purple-50 border-l-4 border-purple-600 p-4 rounded mt-4">
                        <p class="text-sm text-gray-700">Distribusi merata di kawasan padat penduduk dengan aksesibilitas tinggi</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8 space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-bold text-gray-800"><?= number_format($jumlah) ?> unit (<?= $rounded ?>%)</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-10 overflow-hidden">
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 h-10 rounded-full flex items-center justify-end px-3 text-white text-sm font-semibold transition-all duration-500 chart-bar" style="width: <?= $rounded ?>%"></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center p-6 bg-purple-50 rounded-lg border-l-4 border-purple-600">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Hampir seluruh wilayah Bandar Lampung memiliki akses mudah ke tempat ibadah dalam radius 1 km.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-6 bg-blue-50 rounded-lg border-l-4 border-blue-600">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Setiap kecamatan memiliki rata-rata 67 sarana ibadah untuk melayani masyarakat.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-6 bg-green-50 rounded-lg border-l-4 border-green-600">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Rata-rata 1 sarana ibadah melayani sekitar 750 penduduk, menunjukkan distribusi yang baik.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 bg-gradient-to-r from-purple-600 to-purple-800">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 border-2 border-white border-opacity-20">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-6">
                <div class="flex flex-col md:flex-row gap-4">
                    <input type="text" id="searchBox" class="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-600 transition" placeholder="Cari nama tempat ibadah...">
                    <select id="filterCategory" class="px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-600 transition">
                        <option value="">Semua Kategori</option>
                        <?php foreach ($kategori_counter as $kat => $jml): ?>
                        <option value="<?= htmlspecialchars($kat) ?>"><?= htmlspecialchars($kat) ?> (<?= $jml ?>)</option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="facilityGrid">
                ...
                <div class="facility-card bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition border-l-4 border-purple-600" data-category="<?= htmlspecialchars($tempat['kategori']) ?>">
                    <span class="inline-block px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-semibold mb-2"><?= htmlspecialchars($tempat['kategori']) ?></span>
