        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <ul class="hidden md:flex space-x-8">
                    ...
                    <li><a href="/pages/kesehatan.php" class="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">Kesehatan</a></li>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-kesehatan" checked class="w-4 h-4"><span class="text-gray-700">Rumah Sakit (24)</span></label>
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center p-6 bg-blue-50 rounded-lg border-l-4 border-blue-600">
                        ...
                        <div><h4 class="text-lg font-semibold text-gray-800 mb-1">Coverage Area</h4><p class="text-gray-600">Hampir seluruh wilayah Bandar Lampung tercakup dalam radius 5 km dari rumah sakit terdekat.</p></div>
                    </div>
                    <div class="flex items-center p-6 bg-green-50 rounded-lg border-l-4 border-green-600">
                        ...
                        <div><h4 class="text-lg font-semibold text-gray-800 mb-1">Radius Pelayanan (km)</h4><p class="text-gray-600">Rata-rata jarak tempuh dari permukiman ke RS terdekat adalah 3–5 km.</p></div>
                    </div>
                    <div class="flex items-center p-6 bg-purple-50 rounded-lg border-l-4 border-purple-600">
                        ...
                        <div><h4 class="text-lg font-semibold text-gray-800 mb-1">Rasio RS : Kecamatan</h4><p class="text-gray-600">24 RS untuk 20 kecamatan — rata-rata 1–2 RS per kecamatan.</p></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-gradient-to-r from-blue-600 to-blue-800">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 border-2 border-white border-opacity-20 hover:bg-opacity-20 transition">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition border-t-4 border-blue-600">
                    ...
                    <span class="inline-block px-3 py-1 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-full text-sm font-semibold mb-3"><?= htmlspecialchars($rs['kategori']) ?></span>
