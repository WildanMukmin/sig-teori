        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <ul class="hidden md:flex space-x-8">
                    ...
                    <li><a href="/pages/pendidikan.php" class="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">Pendidikan</a></li>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-pendidikan" checked class="w-4 h-4"><span class="text-gray-700">Fasilitas Pendidikan (362)</span></label>
                    ...
                    <label class="flex items-center space-x-2"><input type="checkbox" id="layer-ibadah" class="w-4 h-4"><span class="text-gray-700">Sarana Ibadah (1340)</span></label>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-600">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-green-600 mr-2">•</span>Kepadatan fasilitas sangat tinggi</li>
                        <li class="flex items-start"><span class="text-green-600 mr-2">•</span>Pusat magnet pelajar</li>
                        <li class="flex items-start"><span class="text-green-600 mr-2">•</span>TK hingga Perguruan Tinggi lengkap</li>
                    </ul>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-yellow-500">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-yellow-600 mr-2">•</span>Distribusi fasilitas mulai merata</li>
                        <li class="flex items-start"><span class="text-yellow-600 mr-2">•</span>Potensi pengembangan tinggi</li>
                    </ul>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-red-500">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-red-600 mr-2">•</span>Kepadatan fasilitas sangat rendah</li>
                        <li class="flex items-start"><span class="text-red-600 mr-2">•</span>Butuh penambahan sekolah baru</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-10 overflow-hidden">
                        <div class="bg-gradient-to-r from-green-500 to-green-600 h-10 rounded-full flex items-center justify-end px-3 text-white text-sm font-semibold transition-all duration-500 chart-bar" style="width: <?= $rounded ?>%"></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-6">
                <input type="text" id="searchBox" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-600 transition" placeholder="Cari nama sekolah...">
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="facilityGrid">
                <?php foreach ($pendidikan_data as $sekolah): ?>
                <div class="facility-card bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition border-l-4 border-green-600">
                    <span class="inline-block px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold mb-2"><?= htmlspecialchars($sekolah['kategori']) ?></span>
