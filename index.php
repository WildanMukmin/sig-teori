...
<body class="bg-gray-50">
    <!-- Header -->
    <header class="bg-white shadow-md sticky top-0 z-10000">
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <ul class="hidden md:flex space-x-8">
                    <li><a href="/index.php" class="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">Beranda</a></li>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
                        ...
                        <p class="text-sm text-gray-500 bg-green-50 p-3 rounded">Potensi pengembangan permukiman baru</p>
                    </div>
                </div>
            </div>
        </section>
